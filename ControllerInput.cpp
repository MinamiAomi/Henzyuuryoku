...
std::vector<Controller::State> Controller::mData;
bool Controller::mIsInput = false;

bool Controller::isUse(const State& data){
...
bool Controller::isTrigger(int index, ControllerButton button){
	if (index < mData.size()) {
...
bool Controller::isPressed(int index, ControllerButton button){
	if (index < mData.size()) {
		if (mData[index].isConnect == true) {
			switch (button)
			{
...
bool Controller::isRelease(int index, ControllerButton button) {
	if (index < mData.size()) {
		if (mData[index].isConnect == true) {
			switch (button)
			{
...
bool Controller::isStickDirection(int index, StickDirection direction) {
	if (index < mData.size()) {
		if (mData[index].isConnect == true) {
			switch (direction)
			{
...
bool Controller::getRightTrigger(int index, int* out) {
	if (out == NULL) {
		return false;
	}
	if (index < mData.size()) {
...
bool Controller::getLeftTrigger(int index, int* out) {
	if (out == NULL) {
		return false;
	}
	if (index < mData.size()) {
...
bool Controller::getRightStick(int index, int* outx, int* outy) {
...
bool Controller::getRightStick(int index, float* outx, float* outy) {
	int x, y;
...
bool Controller::getRightStick(int index, StickMagnitude* out) {
	return getRightStick(index, &(*out).x, &(*out).y);
}

bool Controller::getRightStickNoDeadZone(int index, int* outx, int* outy) {
	if (outx == NULL || outy == NULL) {
		return false;
	}
	if (index < mData.size()) {
...
bool Controller::getRightStickNoDeadZone(int index, float* outx, float* outy) {
	int x, y;
...
bool Controller::getLeftStick(int index, int* outx, int* outy) {
	if (outx == NULL || outy == NULL) {
		return false;
	}
	if (index < mData.size()) {
...
bool Controller::getLeftStick(int index, float* outx, float* outy) {
	int x, y;
...
bool Controller::getLeftStick(int index, StickMagnitude* out) {
	return getLeftStick(index, &(*out).x, &(*out).y);
}

bool Controller::getLeftStickNoDeadZone(int index, int* outx, int* outy) {
	if (outx == NULL || outy == NULL) {
		return false;
	}
	if (index < mData.size()) {
...
bool Controller::getLeftStickNoDeadZone(int index, float* outx, float* outy) {
	int x, y;
